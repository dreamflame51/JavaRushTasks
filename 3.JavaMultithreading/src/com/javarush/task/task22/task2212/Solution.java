...
public class Solution {
    public static boolean checkTelNumber(String telNumber) {
        ...
        if (telNumber.matches("[()0-9+-]+")) {
            ...
            if (((telNumber.length() - telNumber.replaceAll("[(]", "").length()) > 1) || ((telNumber.length() - telNumber.replaceAll("[)]", "").length()) > 1) || ((telNumber.length() - telNumber.replaceAll("[+]", "").length()) > 1) || ((telNumber.length() - telNumber.replaceAll("[-]", "").length()) > 2)) {
